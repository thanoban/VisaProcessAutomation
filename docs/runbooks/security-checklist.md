...
- prompt-injection handling remains mandatory for uploaded-document text
- PII redacted from general logs
- PII and raw security detail redacted before Phoenix export
...
- malware-scanning placeholder present on the upload path
...
- no real personal visa data may be committed, stored, or exported
